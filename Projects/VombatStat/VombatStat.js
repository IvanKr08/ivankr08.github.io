...
// include: C:\Users\IvanKr08\AppData\Local\Temp\tmp6dxixeoc.js
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'bin/VombatStat.Browser/Release/net10.0/browser-wasm/native/VombatStat.data';
      var REMOTE_PACKAGE_BASE = 'VombatStat.data';
...
Module['FS_createPath']("/Data", "Dumps", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_bin/VombatStat.Browser/Release/net10.0/browser-wasm/native/VombatStat.data');

      };
      Module['addRunDependency']('datafile_bin/VombatStat.Browser/Release/net10.0/browser-wasm/native/VombatStat.data');
    ...
    loadPackage({"files": [{"filename": "/Data/Dumps/\u0412\u0441\u0435 \u0438\u0432\u0435\u043d\u0442\u044b \u0437\u0430 2025 \u0433\u043e\u0434.json", "start": 0, "end": 10266603}, {"filename": "/Data/Dumps/\u0418\u0432\u0435\u043d\u0442\u044b \u043f\u043e 2026.02.06.json", "start": 10266603, "end": 27112981}, {"filename": "/Data/Dumps/\u0428\u043b\u0430\u043a\u043e\u0431\u043b\u043e\u043a \u043f\u043e 2026.02.06.json", "start": 27112981, "end": 29274396}, {"filename": "/Data/RobotoSlab-ExtraBold.ttf", "start": 29274396, "end": 29401484}, {"filename": "/Data/RobotoSlab-Medium.ttf", "start": 29401484, "end": 29528348}, {"filename": "/Data/usersex.json", "start": 29528348, "end": 29530469}], "remote_package_size": 29530469});

  })();

// end include: C:\Users\IvanKr08\AppData\Local\Temp\tmp6dxixeoc.js
// include: F:\Projects\VOMBAT\VombatStat\VombatStat\Browser\Shell\pre.js
﻿Module["preRun"].push(function () {
    addRunDependency('syncfs');

    FS.mkdir('/UserData');
    FS.mount(IDBFS, { autoPersist: true }, '/UserData')
    FS.syncfs(true, function (err) {
        if (err) throw err
        removeRunDependency('syncfs')
        console.log('FS Loaded')
    });
});// end include: F:\Projects\VOMBAT\VombatStat\VombatStat\Browser\Shell\pre.js
...
var wasmBinaryFile;
  wasmBinaryFile = 'VombatStat.wasm';
...
// end include: preamble.js
  ...
  var _WriteClipboard = (textPtr) => {
          const supported = navigator.clipboard.readText != undefined;
  
          if (supported) {
              navigator.clipboard.writeText(UTF8ToString(textPtr));
          }
          else {
              const el = document.createElement("textarea");
  
              el.value = UTF8ToString(textPtr);
...
var wasmImports = {
  ...
  /** @export */
  SDL_GetEmscriptenJoystickProduct: SDL_GetEmscriptenJoystickProduct,
  /** @export */
  SDL_GetEmscriptenJoystickVendor: SDL_GetEmscriptenJoystickVendor,
  /** @export */
  SDL_IsEmscriptenJoystickXInput: SDL_IsEmscriptenJoystickXInput,
  /** @export */
  SystemJS_RandomBytes: _SystemJS_RandomBytes,
  /** @export */
  WriteClipboard: _WriteClipboard,
  /** @export */
...
var _EXPORT_SetClipboardBuffer = Module['_EXPORT_SetClipboardBuffer'] = (a0) => (_EXPORT_SetClipboardBuffer = Module['_EXPORT_SetClipboardBuffer'] = wasmExports['EXPORT_SetClipboardBuffer'])(a0);
...
var ___start_em_js = Module['___start_em_js'] = 1955637;
var ___stop_em_js = Module['___stop_em_js'] = 1959748;
